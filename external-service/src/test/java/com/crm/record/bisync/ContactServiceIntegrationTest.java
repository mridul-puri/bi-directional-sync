...
public class ContactServiceIntegrationTest {
    ...
    public void testDeleteContact_Success() {
        ...
        contactService.processContacts(Constants.CRM3, OperationType.CREATE, requestBodies, null, null, null, null);

        List<ContactResponse> responses = contactService.processContacts(
                Constants.CRM3, OperationType.DELETE, null, null, null, null, Collections.singletonList("12345")
        );
    ...
    public void testRateLimiting() {
        List<String> requestBodies = Collections.singletonList("{\"id\":\"55\",\"First_Name\":\"Mridul\",\"Last_Name\":\"Puri\",\"Email\":\"mridul.puri@email.com\",\"Phone\":\"1234567890\",\"Mailing_Street\":\"123 St\",\"Mailing_City\":\"Bangalore\",\"Mailing_State\":\"KA\",\"Mailing_Zip\":\"343143\",\"Mailing_Country\":\"India\"}");

        // Quickly exhaust the rate limit (keeping limit as 5 requests in application.properties file)
        ...
        Assertions.assertEquals(1, responses.size());
        Assertions.assertTrue(responses.get(0).getMessage().contains("Rate limit exceeded"));
    }

    @Test
    @Order(7)
    public void testSyncContact_Success() {
        SyncMessage syncMessage = new SyncMessage();
        syncMessage.setProvider(Constants.CRM2);
        ...
        syncMessage.setContact("{\"vid\":32145,\"properties\":{\"firstname\":{\"value\":\"Mridul\"},\"lastname\":{\"value\":\"Puri\"},\"email\":{\"value\":\"mridul.puri@email.com\"},\"phone\":{\"value\":\"1234567890\"},\"address_street\":{\"value\":\"123 St\"},\"address_city\":{\"value\":\"Bangalore\"},\"address_state\":{\"value\":\"KA\"},\"address_postalcode\":{\"value\":\"42344\"},\"address_country\":{\"value\":\"India\"}}}");
        syncMessage.setSyncTimestamp(String.valueOf(System.currentTimeMillis()));

        List<ContactResponse> responses = contactService.processContacts(
                Constants.CRM2, OperationType.SYNC, null, null, syncMessage, null, null
        );

        Assertions.assertEquals(1, responses.size());
        Assertions.assertTrue(responses.get(0).getMessage().contains("Sync successful"));
    }
}
